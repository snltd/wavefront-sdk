module Wavefront
  ...
  module Validators
    ...
    def valid_path?(path)
      raise Wavefront::Exception::InvalidMetricName unless \
    ...
    def valid_value?(value)
      raise Wavefront::Exception::InvalidMetricValue unless value.is_a?(Numeric)
      true
    end
    ...
    def valid_tags?(tags)
      ...
      #
      tags.each do |k, v|
        unless (k.length + v.length < 254) && k.match(/^[a-z0-9\-_\.]+$/)
