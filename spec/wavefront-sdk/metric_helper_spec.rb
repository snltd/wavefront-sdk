...
class WavefrontMetricHelperTest < MiniTest::Test
  ...
  def _test_gauges_to_wf
    input = [{ path: 'm1.p', ts: 1_548_636_080, value: 0 },
             { path: 'm1.p', ts: 1_548_636_081, value: 1 },
             { path: 'm2.p', ts: 1_548_636_081, value: 9 }]

    assert_equal(input, wf.gauges_to_wf(input))
  end

  def _test_counters_to_wf
  ...
  def _test_flush_gauges
    assert_nil(wf.flush_gauges([]))

    input = [{ path: 'm1.p', ts: 1_548_636_080, value: 0 },
             { path: 'm1.p', ts: 1_548_636_081, value: 1, tags: WH_TAGS },
             { path: 'm2.p', ts: 1_548_636_081, value: 9 }]
  ...
  def _test_flush_gauges_fail
    ...
    assert_includes(wf.buf[:gauges],
                    path: 'm1.p', ts: 1_548_636_080, value: 0)
  end
